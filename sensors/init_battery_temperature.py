    ...
    for device_file in device_files:
        ...
        while initialized == False:
            ...
            if equals_pos != -1:
                ...
                if formatted_temp_string >= constants.BATTERY_MAX_TEMP or (formatted_temp_string < constants.BATTERY_LOW_TEMP and formatted_temp_string > 0):
                ...
                elif (formatted_temp_string <= constants.BATTERY_MAX_TEMP and formatted_temp_string >= constants.BATTERY_LOW_TEMP):
