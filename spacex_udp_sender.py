...
def send_pod_data(pod_data, logging):
    try:
        ...
        pod_data_str = struct.pack('!BBi7I', pod_data.team_id, pod_data.status, pod_data.acceleration.x_g, pod_data.wheel_1_dist, pod_data.wheel_1_speed, pod_data.v_val, pod_data.current, pod_data.main_battery_1_temp, pod_data.pod_temp, pod_data.num_stripes_passed)
        #print pod_data_str
